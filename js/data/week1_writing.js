      ...
      tasks: [
        ...
        },
        {
          ...
          phrases: [
            ...
            { correct: "Caffeine in the afternoon can shorten deep sleep",        scrambled: ["deep", "shorten", "afternoon", "Caffeine", "the", "in", "sleep", "can"] },
            { correct: "A dark cool room helps the brain rest",                   scrambled: ["rest", "the", "cool", "A", "helps", "brain", "dark", "room"] },
            { correct: "Most adults need seven to nine hours each night",         scrambled: ["each", "nine", "Most", "adults", "to", "hours", "night", "need", "seven"] },
          ],
        },
        {
          id: "wr:w1d2:guided",
      ...
      tasks: [
        ...
        },
        {
          ...
          phrases: [
            ...
            { correct: "A simple ping can break a long thought",                               scrambled: ["break", "long", "ping", "thought", "simple", "A", "a", "can"] },
            { correct: "Most apps are designed to pull your attention",                        scrambled: ["pull", "designed", "are", "Most", "to", "apps", "your", "attention"] },
            { correct: "Quiet phone mornings help you start the day clearer",                  scrambled: ["help", "start", "Quiet", "you", "the", "clearer", "phone", "day", "mornings"] },
          ],
        },
        {
          id: "wr:w1d3:guided",
      ...
      tasks: [
        ...
        },
        {
          ...
          phrases: [
            ...
            { correct: "Reading paper maps trains the brain in a different way",               scrambled: ["trains", "different", "in", "Reading", "way", "paper", "the", "a", "maps", "brain"] },
            { correct: "A familiar route is built from many small details",                    scrambled: ["many", "small", "from", "A", "details", "is", "familiar", "built", "route"] },
            { correct: "We remember walked places better than driven ones",                    scrambled: ["better", "than", "places", "remember", "We", "ones", "walked", "driven"] },
          ],
        },
        {
          id: "wr:w1d4:guided",
      ...
      tasks: [
        ...
        },
        {
          ...
          phrases: [
            ...
            { correct: "A round number can feel more honest than a sharp one",               scrambled: ["honest", "round", "feel", "than", "A", "more", "one", "can", "sharp", "number", "a"] },
            { correct: "Stores choose their prices very carefully on purpose",               scrambled: ["very", "purpose", "their", "Stores", "carefully", "prices", "choose", "on"] },
            { correct: "Small differences in price can change a buying choice",              scrambled: ["change", "buying", "in", "differences", "Small", "choice", "a", "can", "price"] },
          ],
        },
        {
          id: "wr:w1d5:guided",
      ...
      tasks: [
        ...
        },
        {
          ...
          phrases: [
            ...
            { correct: "Even with social media our deep circle stays small",                  scrambled: ["deep", "stays", "with", "small", "social", "Even", "circle", "our", "media"] },
            { correct: "Knowing many faces is not the same as knowing people",                scrambled: ["same", "as", "Knowing", "people", "is", "knowing", "the", "many", "not", "faces"] },
            { correct: "Old friendships need fresh moments to stay alive",                    scrambled: ["alive", "fresh", "to", "moments", "Old", "stay", "friendships", "need"] },
          ],
        },
        {
          id: "wr:w1d6:guided",
      ...
      tasks: [
        ...
        },
        {
          ...
          phrases: [
            ...
            { correct: "Good fiction asks us to slow down and feel",                          scrambled: ["slow", "feel", "to", "down", "asks", "Good", "us", "fiction", "and"] },
            { correct: "Reading lets us live many lives in one",                              scrambled: ["lives", "in", "many", "lets", "Reading", "one", "live", "us"] },
            { correct: "A good book can change how we see strangers",                         scrambled: ["see", "change", "we", "A", "strangers", "good", "book", "how", "can"] },
          ],
        },
        {
          id: "wr:w1d7:guided",
